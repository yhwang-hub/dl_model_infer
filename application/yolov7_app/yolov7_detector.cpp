...
{
    namespace yolov7_infer
    {
        void yolov7_detector::initParameters(const std::string& engine_file, float score_thr, float nms_thr)
        {
        ...
        void yolov7_detector::adjust_memory(int batch_size)
        {
            // 申请模型输入和模型输出所用到的内存
        ...
        void yolov7_detector::preprocess_gpu(
        ...
        void yolov7_detector::postprocess_gpu(int ibatch, cudaStream_t stream_)
        {
        ...
        BatchBoxArray yolov7_detector::parser_box(int num_image)
        {
        ...
        BoxArray yolov7_detector::forward(const Image& image)
        {
        ...
        BatchBoxArray yolov7_detector::forwards(const std::vector<Image>& images)
        {
