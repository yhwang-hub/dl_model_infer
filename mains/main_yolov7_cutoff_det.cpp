#include "main_yolov7_cutoff_det.h"

void yolov7_cutoff_det_trt_inference(ai::arg_parsing::Settings *s)
{
    ai::utils::Timer timer; // 创建
    tensorrt_infer::yolov7_cutoff_infer::yolov7_cutoff_detector yolov7_det_obj;
    yolov7_det_obj.initParameters(s->model_path, s->score_thr);
    ...
    {
        auto warmup_batched_result = yolov7_det_obj.forwards(yoloimages);
    }
    ...
    {
        batched_result = yolov7_det_obj.forwards(yoloimages);
    }
