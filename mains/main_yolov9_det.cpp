#include "main_yolov9_det.h"

void yolov9_det_trt_inference(ai::arg_parsing::Settings *s)
{
    ai::utils::Timer timer; // 创建
    tensorrt_infer::yolov9_infer::yolov9_detector yolov9_det_obj;
    yolov9_det_obj.initParameters(s->model_path, s->score_thr);
    ...
    {
        auto warmup_batched_result = yolov9_det_obj.forwards(yoloimages);
    }
    ...
    {
        batched_result = yolov9_det_obj.forwards(yoloimages);
    }
